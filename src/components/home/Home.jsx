  ...
  return (
       ...
       <div className='  md:w-[560px] text-center md:text-start'>
        ...
        <ul className=' text-start ms-[0vw] md:w-auto md:ms-0 mt-[10vh]'>
          ...
          <li className='mb-[4vh] md:flex justify-between w-[75%]'>
            <div>
              <h1 className='text-[9vw] md:text-[5vw] font-medium text-[#3379C1]'>21</h1><br />
              <p className='md:text-[1.5vw] font-semibold text-[#101828]'>Programs held</p>
            </div>
            <div>
              <h1 className='text-[9vw] md:text-[5vw] font-medium text-[#3379C1]'>1,651</h1><br />
              <p className='md:text-[1.5vw] font-semibold text-[#101828]'>Attendance so far</p>
            </div>
          </li>
          <li className='mb-[4vh] md:flex justify-between w-[75%]'>
            <div>
              <h1 className='text-[9vw] md:text-[5vw] font-medium text-[#3379C1]'>10k</h1><br />
              <p className='md:text-[1.5vw] font-semibold text-[#101828]'>Consultations</p>
            </div>
            <div>
              <h1 className='text-[9vw] md:text-[5vw] font-medium text-[#3379C1]'>200+</h1><br />
              <p className='md:text-[1.5vw] font-semibold text-[#101828]'>Relief packages sent</p>
            </div>
          </li>
        </ul>
       </div>
   ...
   <div className='md:my-[20vh] flex md:flex-row flex-col justify-between md:h-[80vh] w-[80vw] text-center md:text-start md:w-[82.5vw] mx-auto'>
             ...
             <ul>
              <li  className='mb-[5vh]'>
               ...
               <p className='md:text-[1.5vw]  mt-[5vh] text-[#666666]'>See our senior savor their old age</p> 
                ...
                <li className='my-[5vh]' >
                <h2 className='font-bold md:text-[3vw] text-[6vw]'>Our Mission</h2>
               ...
               <p className='md:text-[1.3vw] mt-[5vh] text-[#666666] md:w-[435px] text-start mx-auto md:mx-0 w-[80vw] '>We engage the younger generation to achieve a paradigm shift from merely looking after our seniors to catering to their NEEDS (physical, psychological and emotional).</p> 
               <p className='md:text-[1.4vw] mt-[5vh] text-[#666666] md:w-[435px] text-start mx-auto md:mx-0 w-[80vw]'>MopCare empowers seniors to savor their old age; live with dignity and choice while engaging the younger generation to imbibe the proper perspective of catering to the needs our seniors rather than merely looking after them to keep them alive.</p> 
                </li>
             </ul>
             </div>
             <div className='md:mt-0 mt-[10vh]'>
              <div className='flex' ><img className='md:w-[250px] w-[45vw] m-[10px]' src={Im} alt="" /><img className='md:w-[270px] w-[35vw] m-[10px] md:h-[270px] mt-auto' src={Image2} alt="" /></div>
              <div className='flex'><img className='md:w-[164px] w-[25vw] m-[10px] md:h-[285px]' src={Image3} alt="" /><img className='md:w-[356px] w-[55vw] m-[10px]' src={Image4} alt="" /></div>
             {/* <img src={two} alt="two" /> */}
             </div>
         </div>
         <div className='text-center py-[20vh]'>
           ...
           <p className='md:text-[20px] text-[4vw]'>To see our seniors savor their old age.</p>
